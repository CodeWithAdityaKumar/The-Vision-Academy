...
export default function Notices() {
  ...
  const [filter, setFilter] = useState('all'); // all, urgent, general
              ...
              {filteredNotices.map((notice) => (
                ...
                >
                  ...
                  <div className="flex items-center text-sm text-gray-500 dark:text-gray-400">
                    ...
                    {notice.timestamp.toLocaleTimeString()}
                  </div>
                </motion.div>
              ))}
            </AnimatePresence>
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400">
              {filter === 'all' 
                ...
                : `There are no ${filter} notices available.`}
            </p>
          </motion.div>
        )}
      </div>
