...
export default function HeroSection() {
  ...
  return (
    <div className="relative bg-gradient-to-r from-blue-100 to-blue-50 dark:from-gray-800 dark:to-gray-900 overflow-hidden min-h-screen flex items-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 lg:py-24 w-full">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="w-full md:w-1/2 mb-8 md:mb-0 z-10">
            ...
            <button className="bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-6 rounded-full text-lg transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg animate-fade-in-up animation-delay-900">
              Join Us
            </button>
          </div>
      ...
      <div className="absolute top-0 right-0 -mt-20 -mr-20 lg:mt-0 lg:mr-0 z-0">
        <svg width="404" height="404" fill="none" viewBox="0 0 404 404" aria-hidden="true" className="text-blue-200 dark:text-blue-900 opacity-25">
          <defs>
