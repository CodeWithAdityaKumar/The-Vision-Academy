...
const SideBarMenu = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      subItems: [
        { title: 'Add Users', url: '/pages/account/dashboard/admin/users/addUser' },
        { title: 'Manage Users', url: '/pages/account/dashboard/admin/users/manageUsers' }
      ]
    },
    {
      title: 'Classes',
      ...
      subItems: [
        { title: 'Create Class', url: '/pages/account/dashboard/admin/classes/create' },
        { title: 'Manage Class', url: '/pages/account/dashboard/admin/classes/manage' }
      ]
    },
    {
      ...
      subItems: [
        { title: 'Add Notes And Books', url: '/pages/account/dashboard/admin/notesAndBooks/add' },
        { title: 'Manage Notes And Books', url: '/pages/account/dashboard/admin/notesAndBooks/manage' }
      ]
    },
    {
      title: 'Attendance',
