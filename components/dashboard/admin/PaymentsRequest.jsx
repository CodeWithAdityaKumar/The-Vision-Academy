...
const PaymentsRequest = () => {
    ...
    return (
        <div className="p-6">
            <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Student Fees Management</h2>
            
            {/* Class Fees Management Section */}
            <div className="mb-8">
                <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Class-wise Monthly Fees</h3>
            ...
            <div className="flex gap-4 mb-6">
                ...
                <input
                    ...
                    className="px-4 py-2 border rounded-lg flex-1 dark:bg-gray-700 dark:text-white"
                />
                <select
                    value={filterClass}
                        ...
                        {filteredStudents.map((student) => {
                            ...
                            return (
                                <tr key={student.id}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">₹{totalDue}</td>
                                    <td className="px-6 py-4 whitespace-nowrap">
