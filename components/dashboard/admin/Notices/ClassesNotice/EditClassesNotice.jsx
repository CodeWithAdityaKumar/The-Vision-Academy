...
export default function EditClassesNotice({ notice, onClose }) {
    ...
    const [formData, setFormData] = useState({
        ...
        isForAllClasses: notice.targetClasses?.includes('all') || false
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const noticeRef = ref(database, `classNotices/${notice.id}`);
