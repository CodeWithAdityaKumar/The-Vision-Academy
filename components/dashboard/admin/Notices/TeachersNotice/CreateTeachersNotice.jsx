...
export default function CreateTeachersNotice() {
    ...
    const [formData, setFormData] = useState({
        ...
        content: '',
        type: 'general',
        targetTeachers: [], // Array of selected teacher IDs
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const noticeRef = push(dbRef(database, 'teacherNotices'));
            ...
            toast.success('Teacher notice created successfully!');
        } catch (error) {
            console.error('Error creating teacher notice:', error);
            toast.error('Failed to create teacher notice');
        } finally {
            setLoading(false);
        }
    };
