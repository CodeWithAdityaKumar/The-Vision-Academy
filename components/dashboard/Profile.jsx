          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
            <motion.div
              whileHover={{ scale: 1.02 }}
                          className="flex items-center space-x-3 p-4 rounded-lg bg-gray-50/30 dark:bg-black/50 backdrop-blur-sm transition-all duration-300 hover:shadow-lg dark:hover:bg-gray-900/50 border border-gray-100 dark:border-gray-800 overflow-hidden"
            >
            ...
            {profileData?.role === "teacher" && (
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900 dark:text-gray-100">
                    {profileData?.subject || "Not provided"}
                  </p>
                </div>
              </motion.div>
            )}
            ...
            {profileData?.role === "student" && (
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900 dark:text-gray-100">
                    {profileData?.class || "Not provided"}
                  </p>
                </div>
              </motion.div>
            )}
