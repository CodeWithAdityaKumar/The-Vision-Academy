...
export default function TeacherNotices() {
    ...
    const teacherId = "teacher1"; // Temporary teacher ID for demonstration
            ...
            if (data) {
                const noticesList = Object.entries(data)
                    ...
                    .filter(notice => 
                        ...
                        notice.targetTeachers.includes(teacherId)
                    )
            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                        View all notices and announcements for you
                    </p>
                </motion.div>

                {/* Filter Buttons */}
                <div className="flex justify-center gap-4 mb-8 flex-wrap">
                    {['all', 'urgent', 'general', 'meeting', 'announcement'].map((type) => (
                        <button
                            key={type}
