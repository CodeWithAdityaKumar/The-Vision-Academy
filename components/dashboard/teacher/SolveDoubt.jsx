...
const SolveDoubt = ({ teacherSubject, teacherId, userRole }) => {
      ...
      try {
        ...
        const dummyDoubts = [
          ...
          },
          {
            id: 2,
            subject: 'Mathematics',
            question: 'Help with integration',
            imageUrl: '/images/about.png',
            status: 'pending',
        ...
        // Filter doubts based on role and subject
        const filteredDoubts = userRole === 'admin' 
          ? dummyDoubts // Show all doubts for admin
          : dummyDoubts.filter(doubt => doubt.subject === teacherSubject);
  ...
  // Add a subject filter for admin
  // const renderAdminSubjectFilter = () => {
  //   if (userRole !== 'admin') return null;

  //   const subjects = ['All Subjects', 'Physics', 'Mathematics', 'Chemistry', 'Biology'];
    ...
    <div className="sticky top-0 z-10 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm py-4 mb-6">
      <div className="flex flex-col sm:flex-row gap-4 items-center">
        ...
        <div className="flex gap-2 w-full sm:w-auto">
          {/* {userRole === 'admin' && renderAdminSubjectFilter()} */}
          <select
            value={filter}
  ...
  const renderDoubtCard = (doubt) => (
    ...
    >
      ...
      <div className="p-4">
        ...
        {userRole === "admin"? <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
  ...
  return (
    ...
    >
      ...
      {doubts.length === 0 && !loading && renderEmptyState()}
